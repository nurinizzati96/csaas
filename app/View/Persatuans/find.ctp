...
<?php echo $this->Form->input('nama', array(
    'class' => 'form-control', 
    'placeholder' => 'Nama Persatuan', 
    'label' => 'Nama Persatuan')); ?> 
           

<br>

<?php
    echo $this->Form->button('<i class="glyphicon glyphicon-search"></i> Cari', array(
    'type' => 'submit',
				...
				<div class="panel panel-default">
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
								...
								<?php echo $this->Html->link(__('<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Daftar Persatuan'), array('action' => 'add'), array('class'=>'btn btn-primary btn-block', 'escape' => false)); ?>							
